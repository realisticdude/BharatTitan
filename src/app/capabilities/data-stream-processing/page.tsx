...
import { Database, Activity, ShieldCheck, ChevronRight, Home, ArrowRight, Image as ImageIcon } from 'lucide-react';
import Link from 'next/link';

export default function DataStreamProcessing() {
  const features = [
    { 
      title: "REAL-TIME PIPELINES", 
      desc: "Process and analyze data as it happens.",
      icon: Activity
    },
    { 
    ...
    { 
      ...
      desc: "Ensure accuracy, consistency, and availability.",
      icon: ShieldCheck
    }
  ];
    ...
    <div className="min-h-screen bg-background text-foreground pt-32 pb-0 px-6 overflow-hidden transition-colors duration-500">
      <div className="max-w-7xl mx-auto">
        ...
        <nav className="flex items-center gap-2 text-[10px] font-orbitron uppercase tracking-widest text-muted-foreground mb-12">
          ...
          <ChevronRight size={10} />
          <span className="text-foreground font-bold">Data Stream Processing</span>
        </nav>
          ...
          <div className="lg:col-span-5 flex flex-col justify-center">
            ...
            >
              <h1 className="font-orbitron text-5xl md:text-6xl font-black mb-8 tracking-tighter leading-[0.9] text-slate-900 dark:text-white">
                DATA STREAM <br /> <span className="text-accent">PROCESSING</span>
              </h1>
              
              <p className="text-muted-foreground text-sm font-sans leading-relaxed mb-12 max-w-md">
                We handle real-time data flows and pipelines with speed, accuracy, and optimized performance.
              </p>
              ...
              >
                Process Your Data <ChevronRight size={14} />
              </Link>
            </motion.div>
          </div>
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            >
              ...
              <div className="absolute inset-0 z-0">
                 <img 
                    src="/placeholder-data.jpg" 
                    alt="Data Stream Processing Visual" 
              ...
              <div className="relative z-10 flex flex-col items-center gap-6 text-slate-400 dark:text-slate-600">
                ...
                <span className="font-orbitron text-[10px] tracking-[0.4em] uppercase text-center">
                  DATA STREAM PROCESSING <br /> VISUAL
                </span>
              </div>
