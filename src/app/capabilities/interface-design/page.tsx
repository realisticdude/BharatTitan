...
import { Layout, UserCheck, Sparkles, Smartphone, ChevronRight, Home, ArrowRight, Image as ImageIcon } from 'lucide-react';
...
export default function InterfaceDesign() {
  const features = [
    { 
      ...
      desc: "Focused on usability, accessibility, and clarity.",
      icon: UserCheck
    },
    { 
      title: "FUTURISTIC AESTHETICS", 
      desc: "Modern UI with premium visual appeal.",
      icon: Sparkles
    },
    { 
    ...
    <div className="min-h-screen bg-background text-foreground pt-32 pb-0 px-6 overflow-hidden transition-colors duration-500">
      <div className="max-w-7xl mx-auto">
        ...
        <nav className="flex items-center gap-2 text-[10px] font-orbitron uppercase tracking-widest text-muted-foreground mb-12">
          ...
          <ChevronRight size={10} />
          <span className="text-foreground font-bold">Interface Design</span>
        </nav>
          ...
          <div className="lg:col-span-5 flex flex-col justify-center">
            ...
            >
              <h1 className="font-orbitron text-5xl md:text-6xl font-black mb-8 tracking-tighter leading-[0.9] text-slate-900 dark:text-white">
                INTERFACE <br /> <span className="text-accent">DESIGN</span>
              </h1>
              
              <p className="text-muted-foreground text-sm font-sans leading-relaxed mb-12 max-w-md">
                We craft clean, modern, and futuristic interfaces that deliver exceptional user experiences.
              </p>
              ...
              >
                Design Your Experience <ChevronRight size={14} />
              </Link>
            </motion.div>
          </div>
