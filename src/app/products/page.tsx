        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-32">
          {products.map((product, index) => (
            <motion.div
              ...
              className="group relative min-h-[320px] bg-card/40 backdrop-blur-md border border-white/5 overflow-hidden hover:border-accent transition-colors duration-500 rounded-xl"
            >
              ...
              <div className="relative z-10 h-full p-10 flex flex-col justify-between">
                <div>
                  <div className="flex items-center justify-between mb-4">
                    <div className="inline-block px-3 py-1 bg-accent/10 border border-accent/30 text-accent text-xs font-bold tracking-wider uppercase rounded">
                      {product.tag}
                    </div>
                    <span className="text-[10px] font-orbitron text-accent opacity-0 group-hover:opacity-100 transition-opacity">
                      &gt; UNLOCKING MODULE...
                    </span>
                  </div>
                  <h3 className="font-orbitron text-3xl font-bold text-white mb-4 group-hover:text-accent transition-colors">
                    {product.name}
                  </h3>
                  {/* 2. PRODUCT DETAIL EXPANSION */}
                  <p className="text-muted-foreground text-sm font-sans leading-relaxed opacity-0 group-hover:opacity-100 transform translate-y-2 group-hover:translate-y-0 transition-all duration-500 max-w-sm">
                    {product.desc}
                  </p>
                </div>
